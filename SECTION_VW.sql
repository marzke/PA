CREATE VIEW AASCIEPT.SECTION_VW AS select to_number(concat(t.STRM, t.CLASS_NBR)) as id,
...
join (select * from CMSCOMMON.SFO_CR_IOC_VW union select * from CMSCOMMON.SFO_CR_IOC_NO_VW) i
on i.strm=t.strm and i.CLASS_NBR=t.CLASS_NBR
and t.class_type = 'E'
where t.strm='2183' and t.acad_org like '572%'
